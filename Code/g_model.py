                ...
                with tf.name_scope('scale_' + str(scale_num)):
                    with tf.name_scope('setup'):
                        ...
                        for i in range(len(self.scale_kernel_sizes[scale_num])):
                            ws.append(w([int(self.scale_kernel_sizes[scale_num][i]),
                                         int(self.scale_kernel_sizes[scale_num][i]),
                                         int(self.scale_layer_fms[scale_num][i]),
                                         int(self.scale_layer_fms[scale_num][i + 1])]))
                            bs.append(b([int(self.scale_layer_fms[scale_num][i + 1])]))
